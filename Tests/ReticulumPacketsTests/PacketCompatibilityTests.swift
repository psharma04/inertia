...
// Packet implementation and the Python RNS reference implementation.
//
// Fixtures are generated by:
//   python Tests/Scripts/generate_fixtures.py
//
// Full wire layout (HEADER_1, no IFAC):
//
//   Bytes 0–18  : PacketHeader (see PacketHeader.swift for bit layout)
//   Bytes 19+   : payload (arbitrary bytes)
//
// Tests FAIL until Packet.deserialize() and Packet.serialize() are implemented.
