...
// PacketHeader Protocol Compatibility Tests
//
// These tests verify byte-for-byte binary compatibility between the Swift
// PacketHeader implementation and the Python RNS reference implementation.
//
// Fixtures are generated by:
//   python Tests/Scripts/generate_fixtures.py
//
// Wire format (HEADER_1, no IFAC):
//
//   Byte  0      : flags byte
//                  bits [7:6] = header_type      (0=HEADER_1, 1=HEADER_2)
//                  bits [5:4] = propagation_type (0=BROADCAST, 1=TRANSPORT)
...
//   Bytes 19+    : payload
//
// Tests FAIL until PacketHeader is implemented in ReticulumPackets.
