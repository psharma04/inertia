...
// Identity Protocol Compatibility Tests
//
// These tests verify byte-for-byte binary compatibility between the Swift
// Identity implementation and the Python RNS reference implementation.
//
// Fixtures are generated by:
//   python Tests/Scripts/generate_fixtures.py
//
// Tests FAIL until Identity is fully implemented in ReticulumCrypto.
